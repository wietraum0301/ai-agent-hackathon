  ...
  return (
    <section className="py-24 relative overflow-hidden bg-muted/50">
      ...
      <div className="relative z-10 container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div className="group p-8 rounded-2xl bg-background border-2 border-primary/40 hover:border-primary hover:shadow-2xl transition-all duration-500 animate-fade-up relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-2xl font-bold text-foreground mb-3">AI 구축 인건비 500만원</h3>
              <p className="text-muted-foreground break-keep">
                해커톤에서 완성한 프로토타입을 실제 서비스로 발전시킬 수 있도록
                전문 인력 비용을 지원합니다.
              </p>
            </div>
          </div>
          ...
          {/* Secondary Prize */}
          <div className="group p-8 rounded-2xl bg-background border-2 border-primary/40 hover:border-primary hover:shadow-2xl transition-all duration-500 animate-fade-up relative overflow-hidden" style={{ animationDelay: '0.1s' }}>
        ...
        {/* ISV Partner Benefit */}
        <div className="max-w-4xl mx-auto mt-8 p-6 rounded-2xl bg-background border border-primary/20 text-center animate-fade-up" style={{ animationDelay: '0.2s' }}>
          ...
          <p className="text-muted-foreground text-sm break-keep">
            메가존클라우드 ISV 파트너로 <span className="text-foreground font-medium">Microsoft Marketplace에 솔루션 게시</span> 특전이 제공됩니다.
          </p>
        </div>
      </div>
    </section>
